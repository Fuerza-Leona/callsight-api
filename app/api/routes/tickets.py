...
async def get_mine(
    ...
    try:
        ...
        if role == UserRole.AGENT: # If agent, get tickets based on assigned_to. If user, created_by. Admins and leaders see all tickets.
            tickets_response = (
...
async def add_message(
    ...
    try:
        ...
        ticket = supabase.table("support_tickets").select("*").eq("ticket_id", ticket_id).execute()
