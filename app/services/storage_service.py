...
async def process_topics(supabase: Client, topics: List[str], conversation_id: str) -> None:
...
async def process_transcripts(supabase: Client, phrases: List[Dict[str, Any]], conversation_id: str) -> None:
