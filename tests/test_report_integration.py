...
from app.api.routes.reports import generate_monthly_report
...
async def test_report_generation_integration():
    ...
    storage_mock.get_public_url.return_value = "https://example.com/test-integration-report.pdf"
    mock_supabase.storage.from_.return_value = storage_mock
    
    # Mock database insertion
    table_mock = MagicMock()
    table_mock.insert.return_value.execute.return_value.data = [{"report_id": "test-integration-id"}]
