...
def mock_wav_file():
    ...
    file.content_type = "audio/wav"  # Set content_type explicitly
    return file
...
def mock_mp3_file():
    ...
    file.content_type = "audio/mpeg"  # Set content_type explicitly
    return file
...
def mock_invalid_file():
    ...
    file.content_type = "text/plain"  # Set content_type explicitly
    return file
